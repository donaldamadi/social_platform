...
class _AddAQuestionState extends State<AddAQuestion> {
  ...
  Future<void> setQuestionText(BuildContext context) async {
    ControlChangeNotifierModel controlModel =
        Provider.of<ControlChangeNotifierModel>(context, listen: false);
  ...
  ask() async {
    ...
    await setQuestionText(Get.context!);
    if (topic == null || topic!.isEmpty) {
      toastMessage("Please add a topic", context);
    } else if (titleController.text.isEmpty) {
      toastMessage("Title cannot be left empty", context);
    } else {
      controlModel.askQuestion(
  ...
  Widget build(BuildContext context) {
    ...
    ControlChangeNotifierModel controlModel =
        Provider.of<ControlChangeNotifierModel>(context, listen: false);
    return Scaffold(
      appBar: customAppBar(context, "Ask a Question"),
      body: SafeArea(
        child: Stack(
          children: [
            Column(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CustomButton(
                          ...
                          height: 30,
                          width: 60),
                      // GestureDetector(onTap: () => ask(), child: textControl("Ask", context, color: colors.paddygreen)),
                    ],
                  ),
                ),
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Padding(
                        //   padding: EdgeInsets.symmetric(horizontal: 20),
                        //   child: textControl("Type your question", context,
                        ...
                        //           child: Html(
                        //             key: contentKey,
                        //             data: (controlModel.questionText == null ||
                        //                     controlModel.questionText == "")
                        //                 ? "Start typing here..."
                        //                 : controlModel.questionText,
                        //             style: {
                ...
                child: GestureDetector(
                  onTap: () {
                    quickActionModalBottomSheet2(context,
                        extraPop: true, type: QuickActions.question);
                  },
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        textControl("Ask Question", context,
                            color: colors.paddygreen),
